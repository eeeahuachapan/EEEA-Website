    ...
    return (
        <div className="h-screen min-h-screen flex flex-col items-center font-Montserrat">
            ...
            <section className="w-full lg:h-5/6 flex flex-col lg:flex-row items-end lg:items-stretch lg:bg-shapes lg:z-0  ">
                ...
                <div className="flex flex-col lg:flex-row  w-full min-h-screen lg:min-h-full lg:w-11/12 lg:flex-wrap lg:justify-between lg:items-stretch items-center gap-6 p-6 lg:overflow-y-auto lg:bg-shapes lg:z-0">
