...
function Facilities() {
    return (
        <div className="min-h-screen flex flex-col items-center">
            ...
            <h1 className='font-bold text-secondary text-xl lg:text-3xl lg:font-extrabold lg:mt-12'>Instalaciones</h1>
            ...
            <section className="w-11/12 h-60 lg:h-96 my-6 carousel rounded-box">
                <div className="carousel-item w-full">
                    <img src="/escuelas.png" className="w-full object-contain"/>
                </div>
                <div className="carousel-item w-full">
                    <img src="https://daisyui.com/images/stock/photo-1565098772267-60af42b81ef2.jpg" className="w-full object-contain" />
                </div>
                <div className="carousel-item w-full">
                ...
                <div className="carousel-item w-full">
                    <img src="https://daisyui.com/images/stock/photo-1559181567-c3190ca9959b.jpg" className="w-full object-contain" />
                </div>
                <div className="carousel-item w-full">
                    <img src="/escuelas.png" className="w-full object-contain" />
                </div>
