...
function EventItem({event}) {
  ...
  return (
    <div onClick={onclickHandler} className="font-Montserrat cursor-pointer card card-side bg-base-100 h-32 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-xl flex  lg:w-3/10 lg:h-1/3">
    ...
    <div className="card-body p-5 rounded-r-xl text-xs bg-white lg:text-sm lg:items-start ">
        ...
        <div className='flex text-xs lg:flex-col lg:text-sm lg:gap-2'>
            ...
            {event.completed && (<img src="/src/assets/done.svg" className="w-8 lg:w-10 absolute right-0 bottom-0" alt="" />) }
