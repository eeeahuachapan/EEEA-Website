...
function EventItem() {
  return (
    <div className="card card-side bg-base-100 h-32 shadow-[rgba(0,_0,_0,_0.24)_0px_3px_8px] rounded-xl flex">
    <img src="/src/assets/Imagen2.webp" alt="" className='w-1/3 object-cover rounded-l-xl' />
    <div className="card-body p-5 rounded-r-xl text-xs lg:text-sm bg-white">
        <h1 className='text-secondary text-lg font-bold'>Nombre</h1>
        <div className='flex text-xs'>
            <label className='text-center flex flex-col gap-1 items-center '> 
